...
# Resultaat analyse combineerbaarheid (kies)
...
writeRaster(vernattingsvrije_clusters, filename = str_c("C:/R/NARA2026/nara2026-git/scenarios/", studiegebied, "/output/intolerant_zone_vernatting.tif"), overwrite = TRUE)
```
