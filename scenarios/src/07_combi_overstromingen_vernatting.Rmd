...
- veen1970_poly.shp -\> veengebieden (schaal Vlaanderen)
...
targets <- c("ecosysteem_2022.tif", "toekomstlaag.shp", "veen1970_poly.shp", "wegen.shp", "overstromingsdiepte_t100_flu_plu.tif", "vha.shp", "textuur.tif", "overstromingstolerantie_habitats_gis.xlsx", "grondwaterregime_habitats.xlsx", "aquifer_hcov.tif", "ksat_h_hcov.tif")
...
### Stap 0 - Data klaarmaken en selectie natuurdoelen die minstens 30% van perceel bedekken
...
#///////////////////////////////////////////////
# Natuurdoelen minstens 30% opp. van perceel
#///////////////////////////////////////////////
...
### 2.1. Combineerbaarheid natuurdoelen
...
- Stap 0 - Selectie van percelen met vegetaties die minstens 30% van het perceel bedekken
- Stap 1 - Tolerantiescores koppelen aan vegetaties (minw\*\*d) -\> bij meerdere vegetatietypes per perceel: kies minst tolerante type
- Stap 2 - Schrijf de tolerantiescores voor elk van de dieptes weg als apart raster
- Stap 3 - Vergelijk de tolerantierasters met de waterdiepte
...
#//////////////////////////////////////////////////////////
# Stap 1: Tolerantiescores en combineerbaarheid met overstromingen per perceel
#//////////////////////////////////////////////////////////

# Koppel de tolerantiescores aan de geselecteerde doelen
...
percelen_final <- merge(percelen, percelen_scores, by.x = "ID_perceel", by.y = "ID_perceel", all.x = FALSE)

# Maak een basisraster (10x10m) op basis van de extent van de ecosysteemkaart
target_res <- 10
r_base <- rast(ext(ecosysteem_2022), resolution = target_res, crs = crs(ecosysteem_2022))


#//////////////////////////////////////////////////////////
# Stap 2: tolerantiescores als apart raster
#//////////////////////////////////////////////////////////
...
#//////////////////////////////////////////////////////////
# Stap 3: vergelijk met waterdiepte -> combineerbaarheid
#//////////////////////////////////////////////////////////
...
writeRaster(combineerbaarheid_t100, filename = str_c("C:/R/NARA2026/nara2026-git/scenarios/", studiegebied, "/output/combineerbaarheid_t100.tif"), overwrite = TRUE)
...
# percelen_df uit de vorige analyse (minstens 30% bedekking)
...
# Voeg scores terug toe aan de vector data
percelen_final <- merge(percelen, percelen_scores_bever, by.x = "ID_perceel", by.y = "ID_perceel", all.x = FALSE)
...
# Bereken de combineerbaarheid ifv de diepteligging van de natuurdoelen
...
# Resultaat opslaan (1 = niet combineerbaar)
writeRaster(combineerbaar_bever_t100, filename = str_c("C:/R/NARA2026/nara2026-git/scenarios/", studiegebied, "/output/combineerbaar_bever_t100.tif"), overwrite = TRUE)
```

### 2.2. Zones vrijwaren van overstromingen
...
overstromingsvrije_clusters <- bereikbaar
...
writeRaster(overstromingsvrije_clusters, filename = str_c("C:/R/NARA2026/nara2026-git/scenarios/", studiegebied, "/output/intolerant_zone_t100.tif"), overwrite = TRUE)
```
...
writeRaster(overstromingsvrije_clusters, filename = str_c("C:/R/NARA2026/nara2026-git/scenarios/", studiegebied, "/output/intolerant_zone_bever.tif"), overwrite = TRUE)
```
...
#### b) Combineerbaarheid natuurdoelen
...
# Voeg scores terug toe aan de vector data
percelen_final <- merge(percelen, percelen_scores_glg, by.x = "ID_perceel", by.y = "ID_perceel", all.x = FALSE)
...
# Resultaat opslaan (1 = niet combineerbaar)
writeRaster(combineerbaar_vernattingszone, filename = str_c("C:/R/NARA2026/nara2026-git/scenarios/", studiegebied, "/output/combineerbaar_vernattingszone.tif"), overwrite = TRUE)
```
...
writeRaster(intolerant_vha_vernatting, filename = str_c("C:/R/NARA2026/nara2026-git/scenarios/", studiegebied, "/output/intolerant_vha_vernatting.tif"), overwrite = TRUE)
```
...
# percelen_df uit stap 0 = percelen met alle habitattypes die minstens 30% van het perceel bedekken. Per perceel kunnen dus meerdere rijen voorkomen.
...
writeRaster(invloedszone_veen, filename = str_c("C:/R/NARA2026/nara2026-git/scenarios/", studiegebied, "/output/intolerant_zone_veenherstel.tif"), overwrite = TRUE)
