...
sc1_ecosysteem_finaal <- ifel(tussenstap4 %in% c(101, 102) & !sc1_ecosysteem_ontharding %in% c(101, 102), sc1_ecosysteem_ontharding, tussenstap4)
...
sc2_ecosysteem_finaal <- ifel(tussenstap4 %in% c(101, 102) & !sc2_ecosysteem_ontharding %in% c(101, 102), sc2_ecosysteem_ontharding, tussenstap4)
```
...
sc3_ecosysteem_finaal <- ifel(tussenstap4 %in% c(101, 102) & !sc3_ecosysteem_ontharding %in% c(101, 102), sc3_ecosysteem_ontharding, tussenstap4)
```
